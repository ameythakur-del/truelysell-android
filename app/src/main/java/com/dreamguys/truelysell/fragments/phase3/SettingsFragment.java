...
//                    settingScreenList.getLblSuggession().getName(), R.string.txt_make_a_suggestion));
    ...
    @OnClick({R.id.tv_edit_profile, R.id.rl_change_language, R.id.rl_change_location,
//            R.id.rl_change_apptheme,
//            R.id.rl_make_suggestion,

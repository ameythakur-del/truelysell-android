...
public class AppConstants {
    ...
    public static final String BASE_URL = "http://sevatiger.com/";
    public static final String BASE_URL_IMG = "https://truelysell.dreamguystech.com";
    public static final String COUNTRYLISTURL = BASE_URL + "api/countries";
    public static final String WEBSOCKETURL = "wss://truelysell.com:8443";  // Add your websocket URL
    ...
    public static final String TermsConditionsURL = "http://sevatiger.com/terms-conditions";

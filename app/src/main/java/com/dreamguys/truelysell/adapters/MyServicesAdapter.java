    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        myServicesViewHolder.ivStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(daoMyServices.get(position).getAdminVerification()!=null){
                    if(daoMyServices.get(position).getAdminVerification().equals("1")){
                        if (daoMyServices.get(position).getIs_active().equalsIgnoreCase("1")) {
                        ...
                        Toast.makeText(mContext, "Admin Not verified this service", Toast.LENGTH_LONG).show();
                    }
                } else{
                    Toast.makeText(mContext, "Admin Not verified this service", Toast.LENGTH_LONG).show();
                }

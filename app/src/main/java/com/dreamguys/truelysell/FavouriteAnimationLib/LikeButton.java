...
//        if (SessionHandler.getInstance().get(getContext(), AppConstants.APPTHEME) != null) {
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                likeDrawable.setTint(Color.parseColor(SessionHandler.getInstance().get(mContext, AppConstants.APPTHEME)));
//            }
//        }
        if (iconSize != 0) {
...
//            if (SessionHandler.getInstance().get(getContext(), AppConstants.APPTHEME) != null) {
//                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                    icon.setColorFilter(Color.parseColor(SessionHandler.getInstance().get(mContext, AppConstants.APPTHEME)));
//                }
//            }
        }
    }
